...
public class ApplicationsListActivity extends AppCompatActivity implements ApplicationsRecyclerAdapter.onApplicationListner{
    ...
    private void initObjects() {
        ...
        appsRecyclerAdapter = new ApplicationsRecyclerAdapter(listApps, this);
    ...
    @Override
    public Intent onApplicationClick(int position) {
        Intent i = new Intent();
        i.putExtra("FORM", listApps.get(position));
