...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void updateHodRemarks(int id, String remarks){
        ContentValues cv = new ContentValues();
        cv.put(HOD_REMARKS, remarks);
        db.update(APPLICATION_TABLE, cv, ID + "=?", new String[]{String.valueOf(id)});
    }

    public void updateCoordinatorRemarks(int id, String remarks){
        ContentValues cv = new ContentValues();
        cv.put(COORDINATOR_REMARKS, remarks);
        db.update(APPLICATION_TABLE, cv, ID + "=?", new String[]{String.valueOf(id)});
    }
